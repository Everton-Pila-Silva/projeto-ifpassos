...
function programacao(numero){   
    ...
    if(numero == 5){
        ...
        document.getElementById('divProg').innerHTML = '<div id="divProg"> <div id="progInd"> <img src="img/rodadeconversa.png" id="icone"> <div id="descProg"> <p id="tituloProg"> Roda de conversa com Alunos e Ex-Alunos </p> <p id="horario"> 19:00 - 20:30 </p> <p id="responsavel"> Alunos e Ex-alunos do IF </p> <a id="link-meet" href="meet.google.com/ciw-emdv-jus" target="_blank"> ASSISTIR </a> </div> </div> </div>';
    }   
}
